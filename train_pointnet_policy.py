...
# exp name
exp_name = 'pottery__pointnet' # 'pottery_12pred_7datasetfixed_with_augs' #'subgoal_horizon_5_test_global_center' # 'pottery_20pred_with_augs'
...
pred_horizon = 8 # 12 # 8 # 20
num_epochs = 750
target_shape = "pottery" # ["Line", "X", "Cone", or "All_Shapes"] # TODO: select what shape target you are training for
dataset_path = '/home/acar/Clay_Demos/Pottery_Mar24/' # '/home/alison/Documents/Feb26_Human_Demos_Raw/pottery/'
    ...
    for epoch_idx in tglobal:
        ...
        with tqdm(dataloader, desc='Batch', leave=False) as tepoch:
            ...
            if mean_loss < best_loss and epoch_idx % 50 == 0:
                ...
                torch.save(nets['pointnet_encoder'].state_dict(), join(ckpt_dir, 'pointbert_statedict'))
            ...
            #             tokenized_goals = nets['pointnet_encoder'](goals)
            ...
            #             tokenized_states = nets['pointnet_encoder'](states)
