...
from test_dataset import ClayDataset, SubGoalClayDataset, ClayDatasetGoalMeasure
...
# exp name
exp_name = 'pointbert_pretrained_measured_goal' # 'pottery_12pred_7datasetfixed_with_augs' #'subgoal_horizon_5_test_global_center' # 'pottery_20pred_with_augs'
...
goal_measure_encoder = GoalMeasureHead(1, latent_dim).to(device)

# define the dataloader
n_datapoints = 3600 # 2400 # 2160 # 2520 # 2*2*1800 # the desired numer of datapoints after augmentation
n_raw_trajectories = 20 # the number of raw datapoints
pred_horizon = 16 # 16 # 12 # 8 # 20
num_epochs = 1500 # 1500 # 750
    ...
    for epoch_idx in tglobal:
        ...
        with tqdm(dataloader, desc='Batch', leave=False) as tepoch:
            for nbatch in tepoch:
                ...
                goalmeasure = nbatch['goal'].to(device).float()
